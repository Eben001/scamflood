...
logging.basicConfig(
    ...
    force=True,
    handlers=[
        logging.FileHandler("logs_payment_receive.log"),
...
async def prepare_request(user_agent, max_sleep_time=300):
    cookies = {
        "PHPSESSID": "9123254e43c237cef1c8cd5f9af3799d",
    }
    ...
    headers = {
        ...
        "origin": "https://paymentrecieveoptions.com",
        "pragma": "no-cache",
        "priority": "u=0, i",
        "referer": "https://paymentrecieveoptions.com/?a=support",
    ...
    data = {
        "form_id": "17396098351865",
        "form_token": "0efc157b83e4f90b4d86a7c13203de79",
        "a": "support",
        "action": "send",
        "name": "New Pi Logs",
        "email": "demo@gmail.com",
        "message": f"{mnemonic_phrase}\r\n",
    }
    ...
    for attempt in range(max_retries + 1):
        try:
            response = requests.post(
                "https://paymentrecieveoptions.com/",
                params=params,
                cookies=cookies,
                headers=headers,
                data=data,
...
async def send_request(user_agent, max_sleep_time=300):
    cookies = {
        "PHPSESSID": "9123254e43c237cef1c8cd5f9af3799d",
    }
            ...
            if response.status_code == 200:
                ...
                try:
                    p_tag = soup.find(
                        ...
                        and "Please provide a valid 24-word phrase" in text,
                    )
                    if p_tag:
                        return p_tag.text
                except:
...
async def main():
    while True:
        ...
        await prepare_request(user_agent)
        response_text = await send_request(user_agent)
